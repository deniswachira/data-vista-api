...
import { createVoucher, getAllVouchers, getVoucherByCode, checkoutPayment } from './vouchers.controller';
...
voucherRouter.post('create-checkout-session/:user_id', checkoutPayment);
